...
@Slf4j
@Service
@ConditionalOnMissingBean(EdcNotificationContractService.class)
public class EdcNotificationContractServiceMock implements NotificationContractService {

    @Override
    public CreateNotificationContractResponse handle(CreateNotificationContractRequest request) {
        log.info("MOCK - creating contract notification {}", request);
        return null;
    }
}
