...
class AlertResponseTest {
    ...
    void givenQualityNotification_whenFrom_thenConstructProperAlertResponse() {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("createdBy", notification.getNotificationMessages().stream()
                        .findFirst()
                        .map(QualityNotificationMessage::getCreatedBy)
                        .orElse(null))
                .hasFieldOrPropertyWithValue("createdByName", notification.getNotificationMessages().stream()
                        .findFirst()
